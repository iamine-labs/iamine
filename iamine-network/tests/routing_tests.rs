...
fn test_model_ram_filter() {
    ...
    let low_ram = NodeHardwareProfile {
        ram_gb: 4,
        gpu_available: false,
        storage_available_gb: 20,
    };
    let high_ram = NodeHardwareProfile {
        ram_gb: 16,
        gpu_available: false,
        storage_available_gb: 20,
    };
...
fn test_gpu_requirement_filter() {
    ...
    let no_gpu = NodeHardwareProfile {
        ram_gb: 16,
        gpu_available: false,
        storage_available_gb: 20,
    };
    let with_gpu = NodeHardwareProfile {
        ram_gb: 16,
        gpu_available: true,
        storage_available_gb: 20,
    };
...
fn test_tinyllama_any_node_compatible() {
    ...
    let minimal = NodeHardwareProfile {
        ram_gb: 2,
        gpu_available: false,
