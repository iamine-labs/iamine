...
- network policy: distributed inference permission
...
compatibility, decide backend availability, decide network policy, start
workers, or affect scheduler policy.
