...
| DASHBOARD-NODES-MOCK-001 | APPROVED FOR MERGE | Additive typed, deterministic Nodes preview with complete Mac frontend QA and Architecture review; no discovery, node connectivity, machine identifiers, runtime policy, or operational actions. Core diff is empty; this row does not alter the real-integration sequence. |
