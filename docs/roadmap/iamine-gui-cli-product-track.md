...
| DASHBOARD-DIAGNOSTICS-MOCK-001 | ARCHITECTURE REVIEW REQUIRED | Typed, deterministic, non-authoritative diagnostics preview; Mac frontend and repository validation PASS, core diff empty, and explicitly separate from the future privacy-safe real diagnostics contract. |
