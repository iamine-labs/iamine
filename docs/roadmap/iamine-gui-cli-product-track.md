...
| DASHBOARD-AGENT-CATALOG-001 | READY FOR ARCHITECTURE MERGE REVIEW | Typed, non-authoritative Agent Catalog preview with bounded search, stage filters, local detail selection, complete UI states, and Mac multibrowser QA; real registry data, node availability, permissions, installation, and execution remain blocked. |
