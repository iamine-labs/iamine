...
| DASHBOARD-NODES-MOCK-001 | DEVELOPMENT AUTHORIZED | Additive typed, deterministic Nodes preview only; no discovery, node connectivity, machine identifiers, runtime policy, or operational actions. This row does not alter the real-integration sequence. |
