...
| GUI-CLI-INTERFACE-ARCHITECTURE-001 | READY FOR MERGE REVIEW | Define interface ownership and shared-core boundaries; focused documentation validation passed and no field QA is required. |
