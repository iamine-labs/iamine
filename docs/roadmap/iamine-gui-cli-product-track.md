...
| DASHBOARD-DIAGNOSTICS-MOCK-001 | APPROVED FOR MERGE | Typed, deterministic, non-authoritative diagnostics preview; Architecture review and Mac validation PASS, core diff empty, and explicitly separate from the future privacy-safe real diagnostics contract. |
