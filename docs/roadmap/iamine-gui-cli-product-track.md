...
| DASHBOARD-MODELS-MOCK-001 | DEVELOPMENT AUTHORIZED | Additive typed, deterministic Models preview for Mac-only visual development. No real model identity, registry, artifact, license, compatibility, backend, storage, installation, routing, inference, or execution; the real integration sequence remains unchanged. |
