...
| Feature | State | Primary owner | Goal |
| --- | --- | --- | --- |
| PUBLIC-TESTNET-ADMISSION-001 | ACTIVE | Identity / network policy | Define controlled public operator admission, abuse controls, and removal policy before public beta. |
