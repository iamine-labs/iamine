...
| Feature | State | Primary owner | Goal |
| --- | --- | --- | --- |
| PUBLIC-TESTNET-ADMISSION-001 | PROPOSED | Identity / network policy | Define controlled public operator admission, abuse controls, and removal policy before public beta. |
...
| PUBLIC-TESTNET-DOCUMENTATION-001 | PROPOSED | Documentation / operations | Provide minimum public documentation without launching public beta. |
