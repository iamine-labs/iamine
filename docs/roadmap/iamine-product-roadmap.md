...
| TESTNET-LOAD-RESILIENCE-001 | READY FOR MERGE REVIEW | Runtime, scheduler, QA | Mac/TS140/Proxmox QA PASS; quality gate PASS WITH WARNINGS | Prove bounded behavior under concurrency, partial outages, retries, and recovery. |
