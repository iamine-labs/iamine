...
impl InferenceResult {
    pub fn success(task_id: String, model_id: String, output: String, tokens: u32, ms: u64) -> Self {
        Self { task_id, model_id, output, tokens_generated: tokens, execution_ms: ms, success: true, error: None }
    }

    pub fn failure(task_id: String, model_id: String, error: String) -> Self {
        Self { task_id, model_id, output: String::new(), tokens_generated: 0, execution_ms: 0, success: false, error: Some(error) }
    }
}
