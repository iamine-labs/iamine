...
server-side fallback. Overview, Agents, Nodes, Models, Activity, and Diagnostics
contain bounded preview content. Marketplace remains a placeholder for its own
future feature.
